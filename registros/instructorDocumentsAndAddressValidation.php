...
class InstructorDocumentsAndAddress {
        ...
        function isInstructorIdValid($code) {
            if ($code == null) {
                return array("status" = > false,"erro" =>
                "O campo ID unico do instrutor em Sala é uma informação obrigatória.");
            }
            if (strlen($code) > 20) {
                return array("status" = > false,"erro" =>
                "O campo ID unico do instrutor em Sala está com tamanho diferente do especificado.")
                ;
            } else if (!is_numeric($code)) {
                return array("status" = > false,"erro" =>
                "O campo ID unico do instrutor em Sala foi preenchido com valor inválido");
            }
            return array("status" = > true,"erro" =>"");
        }
        //campo 5
