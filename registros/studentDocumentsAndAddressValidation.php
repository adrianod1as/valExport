...
class StudentDocumentsAndAddress {
        ...
        function isInepCodeValid($code) {
            if (strlen($code) != 12) {
                return array("status" = > false,"erro" =>
                "O campo Identificação única do Profissional escolar em sala de Aula Inep está com tamanho diferente do especificado.")
                ;
            }
            if (!is_numeric($code)) {
                return array("status" = > false,"erro" =>
                "O campo Identificação única do Profissional escolar em sala de Aula Inep foi preenchido com valor inválido")
                ;
            }
        ...
        function isStudentSchoolCodeValid($code) {
            if (strlen($code) > 20) {
                return array("status" = > false,"erro" =>
                " Codigo do Aluno na Escola está com tamanho incorreto");
            }
        ...
        function isRgNumberValid($rg, $Reg60Field12) {
            if ($Reg60Field12 != 1 || $Reg60Field12 != 2) {
                if (strlen($rg) > 20) {
                    return array("status" = > false,"erro" =>
                    "Numero da Identidade não está com tamanho correto");
                }
                if (!preg_match('/^[a-z\d°ºª\- ]{4,20}$/i', $rg)) {
                    return array("status" = > false,"erro" =>
                    "Numero da Identidade está com padrão incorreto");
                }

                return array("status" = > false,"erro" =>
                " Campo 12 do registro 60 deve ser igual a 1 ou 2");
            }
        ...
        function isRgUfValid($rgUF, $Reg60Field12, $Reg70Field5, $Reg70Field6) {
            if ($Reg60Field12 == 1 || $Reg60Field12 == 2) {
                ...
                if (strlen($Reg70Field5) != 0 && strlen($Reg70Field6) != 0) {
                    if (strlen($rgUF) == 0) {
                        return array("status" = > false,"erro" =>
                        "UF da identidade deve ser  preenchido");
                    } else {
                        return array("status" = > true,"erro" =>"");
                    }
                    ...
                    if (strlen($rgUF) != 2) {
                        return array("status" = > false,"erro" =>
                        "UF da identidade preenchido com tamanho inválido");
                    } else {
                        return array("status" = > true,"erro" =>"");
                    }
                } else {
                ...
                if (($currentField == 8) || ($currentField == 14 && $Reg70Field9 == 1)) {
                    if ($isDateValid($expeDate) == true) {
                        ...
                        if ($anoExpedicao > $anoNasceu) {
                            ...
                            if ($anoExpedicao > $anoAtual) {
                                return array("status" = > false,"erro" =>
                                "Data de expedicao superior a data atual");
                            }
                            if ($anoExpedicao == $anoAtual) {
                                //comparar os meses
                        ...
                        if ($anoExpedicao < $anoNasceu) {
                            return array("status" = > false,"erro" =>
                            "Data de expedicao inferior a data de nascimento");
                        }
                        if ($anoExpedicao == $anoNasceu) {
                            //comparar os meses
                        ...
                        return array("status" = > false,"erro" =>
                        "Data de expedicao no formato incorreto");
                    }
                } else {
        ...
        function isCivilCertificationValid($Reg70Field5, $Reg60Field12) {
            if ($Reg60Field12 == 1 || $Reg60Field12 == 2) {
                if ($Reg70Field5 == 1 || $Reg70Field5 == 2) {
                    ...
                    return array("status" = > false,"erro" =>
                    " Certificacao Civil deve ser igual a 1 ou 2");
                }
            } else {
                return array("status" = > false,"erro" =>
                " Campo 12 do registro 60 deve ser igual a 1 ou 2");
            ...
            if ($Reg60Field12 == 1 || $Reg60Field12 == 2) {
                if ($Reg70Field5 == 1) {
                    if ($type == 1) {
                        ...
                        if ($idade < 10) {
                            return array("status" = > false,"erro" =>
                            "Aluno com menos de 10 anos não pode ter certidão de casamento.");
                        }

                        return array("status" = > true,"erro" =>"");
                    } else {
                        return array("status" = > false,"erro" =>
                        "O Tipo de Certificacao Civil deve ser igual a 1");
                    }
                } else {
                    return array("status" = > false,"erro" =>
                    " Campo 9 do registro 70 deve ser igual a 1");
                }
            } else {
                return array("status" = > false,"erro" =>
                " Campo 12 do registro 60 deve ser igual a 1 ou 2");
        ...
        function isCivilRegisterNumberValid($value, Reg60Field12, Reg70Field5) {
            if ($Reg60Field12 == 1 || $Reg60Field12 == 2) {
                ...
                return array("status" = > false,"erro" =>
                " Campo 5 do registro 70 deve ser igual a 2");
            } else {
                return array("status" = > false,"erro" =>
                " Campo 12 do registro 60 deve ser igual a 1 ou 2");
            }
        ...
        function isCPFValid($cpf) {
            if ($cpf == null) {
                return array("status" = > false,"erro" =>
                "O campo Número do CPF é uma informação obrigatória.");
            } else if (strlen($cpf) > 11) {
                return array("status" = > false,"erro" =>
                "O campo Número do CPF está com tamanho diferente do especificado.");
            } // se nao for numerico
            else if (!is_numeric($cpf)) {
                return array("status" = > false,"erro" =>
                "O campo Número do CPF foi preenchido com valor inválido.");
        ...
        function isPassportValid($passport, Reg60Field12) {
            if ($Reg60Field12 == 3) {
                ...
                return array("status" = > false,"erro" =>
                " Campo 12 do registro 60 para estrangeiros deve ter valor 3");
            }
        ...
        function isAreaOfResidenceValid($area_of_residence) {
            if (strlen($area_of_residence) != 1) {
                return array("status" = > false,"erro" =>
                "O campo Localizacao/Area de Residencia foi preenchido com tamanho invalido");
            }
            if ($area_of_residence != 1 || $area_of_residence != 2) {
                return array("status" = > false,"erro" =>
                "O campo Localizacao/Area de Residencia  foi preenchido com valor inválido.");
            }
        ...
        function isCEPValid($cep) {
            if ($cep == null) {
                return array("status" = > false,"erro" =>
                "O campo CEP é uma informação obrigatória.");
        ...
        function isAddressValid($address, $might_be_null, $allowed_lenght) {
            ...
            if (!$might_be_null == true) {
                if ($address == null) {
                    return array("status" = > false,"erro" =>
                    "O campo de endereço não pode ser nulo.");
                } else {
                    return array("status" = > true,"erro" =>"");
                }
